...
public class BackgroundJobServiceTests : IDisposable
{
    ...
    [Fact]
    public async Task EnqueueJob_ShouldAddJobToQueue()
    {
        // Arrange
    ...
    public async Task ProcessJob_ShouldProcessJobSuccessfully()
    {
        ...
        mockFileProcessingService.Verify(x => x.ProcessFileAsync(fileUpload), Times.AtLeastOnce);
    ...
    public async Task ProcessAIAnalysisJob_ShouldProcessAIAnalysisSuccessfully()
    {
        ...
        mockScope.Setup(x => x.ServiceProvider.GetRequiredService<IAnalysisService>())
        ...
        {
            Subject = "Mathematics",
            Topics = new List<string> { "Algebra" },
    ...
    [Fact]
    public async Task ProcessEmailJob_ShouldProcessEmailSuccessfully()
    {
        // Arrange
        var job = new BackgroundJob
        {
    ...
    [Fact]
    public async Task ProcessJob_ShouldHandleUnknownJobType()
    {
        // Arrange
        var job = new BackgroundJob
        {
