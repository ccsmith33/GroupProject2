...
Additional notes: This is supplementary information.";
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Equal("Extracted Study Guide", result.Title);
        Assert.Equal("Main content here", result.Content);
    }
...
2. What is the square root of 16?
   ...
   Answer: B";
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Contains("Math Basics", result.Title);
...
- Study data structure implementations";
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Equal("Computer Science", result.Subject);
        Assert.Contains("OOP", result.KeyPoints);
