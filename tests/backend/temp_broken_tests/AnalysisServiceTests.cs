...
public class AnalysisServiceTests
{
    ...
    public async Task AnalyzeFileAsync_ShouldAnalyzeFileSuccessfully()
    {
        ...
        {
            Subject = "Mathematics",
            Topics = new List<string> { "Algebra", "Mathematics" },
            DifficultyLevel = "Intermediate",
            KeyConcepts = new List<string> { "Algebra", "Equations" },
        ...
        Assert.Contains("Algebra", result.Topics);
    ...
    public async Task GenerateStudyGuideAsync_ShouldGenerateStudyGuide()
    {
        ...
        var fileAnalysis = new FileAnalysis
        {
            ...
            DifficultyLevel = "Intermediate",
            KeyConcepts = new List<string> { "Equations", "Angles" }
        };
        ...
        Assert.Equal("Algebra", result.Sections[0].Title);
    ...
    public async Task GenerateQuizAsync_ShouldGenerateQuiz()
    {
        ...
        Assert.Equal(1, result.Questions[0].CorrectAnswer);
