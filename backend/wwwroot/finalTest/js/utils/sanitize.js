...
/**
 * Sanitizes quiz content (questions, answers, explanations)
 * @param {string} content - The content to sanitize
 * @returns {string} - Sanitized content
 */
export function sanitizeQuizContent(content) {
...
/**
 * Sanitizes study guide content
 * @param {string} content - The content to sanitize
 * @returns {string} - Sanitized content
 */
export function sanitizeStudyGuideContent(content) {
  if (typeof content !== "string") {
    return "";
  }

  // Allow more HTML formatting for study guides
  const allowedTags = [
    "h1",
    "h2",
    "h3",
  ...
  const allowedAttributes = ["class", "href", "src", "alt", "title"];
